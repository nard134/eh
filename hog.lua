-- ✅ FINAL Moon Cat Freeze Script for Delta / Synapse / Fluxus / KRNL
...
-- Function to get all "Moon Cat" models in workspace
...
-- Continuously refreeze all Moon Cats every frame
